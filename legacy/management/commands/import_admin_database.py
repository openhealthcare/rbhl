    ...
    def handle(self, *args, **options):
        ...
        with open(data.abspath) as csvfile:
            ...
            for row in reader:
                ...
                referral.date_first_appointment = str_to_date(
                    row["DateFirstPatientAppt"]
                )
                ...
                cliniclog.histamine_attendance = bol(
                    row["Did patient attend Histamine?"]
                )
                ...
                print("Imported Patient {0}".format(self.patients_imported))
                print(row)
