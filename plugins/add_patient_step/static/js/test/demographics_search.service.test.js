describe('DemographicsSearch', function () {
    ...
    it("should call patient found in application", function () {
        ...
        $httpBackend.expectGET('/search/?hospital_number=111').respond(response);
    ...
    it("should call patient found upstream", function () {
        ...
        DemographicsSearch.find(apiEndPoint, hn, callBacks);
        $httpBackend.flush();
        expect(callBacks.patient_found_upstream).toHaveBeenCalledWith(response.patient);
    });
    ...
    it("should handle http error cases", function () {
        $httpBackend.expectGET('/search/?hospital_number=111').respond(
